...
const TRANSLATIONS: Record<CountryCode, Translations> = {
  IN: {
    ...
    impact_demo_badge: "DEMO DATASET",
    impact_metrics: [
  ...
  BR: {
    ...
    impact_demo_badge: "CONJUNTO DE DADOS DEMO",
    impact_metrics: [
      { value: "4.200", label: "Sinais Verificados", sub: "Dados demonstrativos" },
      { value: "14", label: "Zonas Prioritárias", sub: "Dados demonstrativos" },
  ...
  RU: {
    ...
    impact_demo_badge: "ДЕМОНСТРАЦИОННЫЕ ДАННЫЕ",
    impact_metrics: [
      { value: "4 200", label: "Проверенных Сигналов", sub: "Демонстрационный набор" },
      { value: "14", label: "Приоритетных Зон", sub: "Демонстрационный набор" },
  ...
  CN: {
    ...
    impact_demo_badge: "演示数据集",
    impact_metrics: [
      { value: "4,200", label: "已核验信号数", sub: "演示数据集" },
      { value: "14", label: "高优先红区", sub: "演示数据集" },
  ...
  ZA: {
    ...
    impact_demo_badge: "IDATHA YESIFANEKISO",
    impact_metrics: [
      { value: "4,200", label: "Izimpawu Ezaziwayo", sub: "Idatha yesifanekiso" },
      { value: "14", label: "Izindawo Ezibomvu", sub: "Idatha yesifanekiso" },
